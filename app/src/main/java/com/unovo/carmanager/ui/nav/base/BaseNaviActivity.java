...
public abstract class BaseNaviActivity extends BaseActivity
  ...
  @Override public void onCalculateRouteFailure(int errorInfo) {
    ...
    Log.e("dm", "--------------------------------------------");
    Toast.makeText(this, "errorInfo：" + errorInfo + ",Message：" + ErrorInfo.getError(errorInfo),
  ...
  @Override public void onNaviMapMode(int isLock) {
    //地图的模式，锁屏或锁车
  }
  ...
  @Deprecated @Override public void onNaviInfoUpdated(AMapNaviInfo naviInfo) {
    //过时
  }
  ...
  @Override public void showLaneInfo(AMapLaneInfo[] laneInfos, byte[] laneBackgroundInfo,
