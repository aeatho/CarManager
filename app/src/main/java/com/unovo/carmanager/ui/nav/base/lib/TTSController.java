package com.unovo.carmanager.ui.nav.base.lib;
...
public class TTSController implements AMapNaviListener {
  ...
  public void init() {
    SpeechUtility.createUtility(mContext, "appid=" + Constants.APP_IDS.ID_XUNFEI);
  ...
  public void startSpeaking(String playText) {
    ...
    if (mTts != null) {
      mTts.startSpeaking(playText, new SynthesizerListener() {
        ...
        @Override public void onSpeakProgress(int arg0, int arg1, int arg2) {
          // TODO Auto-generated method stub
        ...
        @Override public void onEvent(int arg0, int arg1, int arg2, Bundle arg3) {
          // TODO Auto-generated method stub

        }

        @Override public void onCompleted(SpeechError arg0) {
          // TODO Auto-generated method stub

        }

        @Override public void onBufferProgress(int arg0, int arg1, int arg2, String arg3) {
          // TODO Auto-generated method stub
