...
import com.unovo.carmanager.BuildConfig;
...
public class LogUtil {
  ...
  private static final String TAG = "car_manager";
  private static final String MSG = "log msg is null.";
  private static final String LOCAL_POWER_PATH ="";
      //FileAccessor.getExternalStorePath() + "/" + "ecsdk_log.txt";
