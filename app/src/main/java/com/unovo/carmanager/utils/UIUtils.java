...
public class UIUtils {
  ...
  public static void runInMainThread(Runnable runnable, long delay) {
    if (isRunInUIThread()) {
      runnable.run();
    } else {
  ...
  public static void showToast(String str) {
    Activity frontActivity = AppManager.getInstance().currentActivity();
  ...
  public static void showToast(int strId) {
    showToast(UIUtils.getString(strId));
  }
