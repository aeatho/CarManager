...
public class DensityUtil {
  ...
  public static int getDisplayMetrics(Context context, float pixels) {
    if (mPixels == 0.0F) mPixels = context.getResources().getDisplayMetrics().density;
  ...
  public static int getImageWeidth(Context context, float pixels) {
    ...
    return context.getResources().getDisplayMetrics().widthPixels - 66 - getDisplayMetrics(context,
        pixels);
  }
  ...
  public static float getDensity(Context context) {
    ...
    if (density < 0.0F) density = context.getResources().getDisplayMetrics().density;
    return density;
  }
