...
public class MediaPlayTools {
  ...
  /**
   * <p>Title: resume</p>
   * <p>Description: Recovery pause language file, from the last to suspend the position to start
   * playing</p>
   */
  public boolean resume() {
    ...
    if (this.status != STATUS_PAUSE) {
      ...
      LogUtil.e(TAG,
          "[MediaPlayTools - resume ] resume not STATUS_PAUSE error status:" + this.status);
      return false;
    }
    ...
    try {
      ...
      e.printStackTrace();
      LogUtil.e(TAG, "[MediaPlayTools - resume ] resume File["
          + this.urlPath
          + "] ErrMsg["
          + e.getStackTrace()
          + "]");
  ...
  public boolean stop() {
    ...
    if (status != STATUS_PLAYING && status != STATUS_PAUSE) {
      ...
      LogUtil.e(TAG, "[MediaPlayTools - stop] stop not STATUS_PLAYING or STATUS_PAUSE error status:"
          + this.status);
      return false;
    }
    ...
    try {
      ...
      e.printStackTrace();
      LogUtil.v(TAG, "[MediaPlayTools - stop]stop File["
          + this.urlPath
          + "] ErrMsg["
          + e.getStackTrace()
          + "]");
  ...
  public boolean pause() {
    if (this.status != STATUS_PLAYING) {
      LogUtil.e(TAG,
          "[MediaPlayTools - pause]pause not STATUS_PLAYING error status:" + this.status);
      return false;
    }
    ...
    try {
      ...
      e.printStackTrace();
      LogUtil.v(TAG, "[MediaPlayTools - pause] pause File["
          + this.urlPath
          + "] ErrMsg["
          + e.getStackTrace()
          + "]");
