 ...
 * @date 2015-1-3
 */
public class UnoAlertDialog extends Dialog implements View.OnClickListener {
   ...
   * @param context
   */
  public UnoAlertDialog(Context context) {
  ...
  public static UnoAlertDialog buildAlert(Context ctx, int message, int button,
      OnClickListener listener) {
    return buildAlert(ctx, ctx.getString(message), ctx.getString(button), listener);
  }

  public static UnoAlertDialog buildAlert(Context ctx, int resId, OnClickListener listener) {
    return buildAlert(ctx, resId, R.string.dialog_btn_cancel, R.string.dialog_btn_confim, null,
        listener);
  }

  public static UnoAlertDialog buildAlert(Context ctx, int resId,
      OnClickListener negativeClickListener, OnClickListener positive) {
    return buildAlert(ctx, ctx.getString(resId), ctx.getString(R.string.dialog_btn_cancel),
        ctx.getString(R.string.dialog_btn_confim), negativeClickListener, positive);
  }

  public static UnoAlertDialog buildAlert(Context ctx, CharSequence message,
      OnClickListener listener) {
    return buildAlert(ctx, message, ctx.getString(R.string.dialog_btn_cancel),
  ...
  public static UnoAlertDialog buildAlert(Context ctx, int message, int leftBtnText, int rightText,
      OnClickListener negativeClickListener, OnClickListener positive) {
    return buildAlert(ctx, ctx.getString(message), ctx.getString(leftBtnText),
        ctx.getString(rightText), negativeClickListener, positive);
  }
   ...
   */
  public static UnoAlertDialog buildAlert(Context ctx, CharSequence message,
      CharSequence leftBtnText, CharSequence rightText, OnClickListener negativeClickListener,
   ...
   * 创建只有一个按钮的对话框
   */
  public static UnoAlertDialog buildAlert(Context ctx, CharSequence message, CharSequence text,
      OnClickListener positive) {
    UnoAlertDialog dialog = new UnoAlertDialog(ctx);
    dialog.setMessage(message);
  ...
  public static UnoAlertDialog buildPositiveAlert(Context ctx, int resId,
      OnClickListener listener) {
   ...
   * @return
   */
  public static UnoAlertDialog buildPositiveAlert(Context ctx, CharSequence message,
      OnClickListener listener) {
    UnoAlertDialog dialog = new UnoAlertDialog(ctx);
    dialog.setMessage(message);
  ...
  public final UnoAlertDialog setButtonTag(int id, OnClickListener listener) {
    Button button = mButtons.get(id);
  ...
  public final void setTitleNormalColor() {
    ((TextView) findViewById(R.id.dialog_tv_title)).setTextColor(
        getContext().getResources().getColor(R.color.text_content));
  }
